...
class SearchRepoItemsUseCase(private val repoItemRepository: RepoItemRepository) {
  suspend operator fun invoke(term: String, page: Int): Either<AppError, List<RepoItem>> =
    repoItemRepository.searchRepoItems(
      term = term,
      page = page,
    )
}
